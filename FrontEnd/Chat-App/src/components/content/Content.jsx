      ...
      <div className="container mx-auto">
        <section className="content-section mb-8">
          ...
          <p className="section-text text-lg">
            ...
            tech industry. Founded in 2010, we have been dedicated to delivering
            high-quality products and services to our clients worldwide. Our
            mission is to empower businesses through technology, fostering
